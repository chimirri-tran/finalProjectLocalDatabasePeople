...
System.out.println("--> REQUEST: getPeople()");
     ...
     * Update the personal information of the Person identified by {id} and return his/her personId
	 ...
	 @Override
	    ...
	    public Long createPerson(Person person) {
	    	...
	    	if(person.currentHealth == null){
	    		...
	    		for(int i=0; i<currentHealthList.size(); i++){
	    			...
	    			newMeasure.setDateRegistered(formatted);
		...
		public Long savePersonMeasure(Long idPerson, Measure measure) {
			...
			if(person != null){
				...
				if(target != null){
					...
					target.setDateRegistered(formatted);
		...
		public Measure updatePersonMeasure(Long idPerson, Measure measure, Long idMeasure) {
			...
			if(existing == null){
				...
				if(existing.getIsCurrent() == 1){
					//change the value
					existing.setDateRegistered(formatted);
		...
		@Override
		public HealthMeasureHistory updateHealthMeasureHistory(HealthMeasureHistory p) {
